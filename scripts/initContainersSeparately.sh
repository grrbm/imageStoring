...
docker run --name mongodb -v /"$(pwd)"/mongo-init.js:/docker-entrypoint-initdb.d/mongo-init.js -v data:/data/db --rm -d -p 27018:27017 --network mern-net mongo --bind_ip 0.0.0.0 --port 27018
